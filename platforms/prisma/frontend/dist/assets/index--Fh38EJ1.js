...
import { K as ae, a2 as le, Y as K, $ as b, X as v, D as h, A as se, a4 as d, a3 as u, E as ce, I as L, J as B, __tla as __tla_0 } from "./core-DDqilddn.js";
import { _ as c, __tla as __tla_1 } from "./pdf-utils-D3SLYqmy.js";
let I, Qe, Tt, w, Je, Ke, l, S, _t, Xe;
let __tla = Promise.all([
    ...
    I = {
        getSpacingStyles (e, t) {
            if (Array.isArray(e)) return e[t] ? `var(--apkt-spacing-${e[t]})` : void 0;
        ...
        generateAvatarColors (e) {
            const o = e.toLowerCase().replace(/^0x/iu, "").replace(/[^a-f0-9]/gu, "").substring(0, 6).padEnd(6, "0"), r = this.hexToRgb(o), n = getComputedStyle(document.documentElement).getPropertyValue("--w3m-border-radius-master"), a = 100 - 3 * Number(n?.replace("px", "")), s = `${a}% ${a}% at 65% 40%`, p = [];
            for(let _ = 0; _ < 5; _ += 1){
                const E = this.tintColor(r, .15 * _);
                p.push(`rgb(${E[0]}, ${E[1]}, ${E[2]})`);
            }
            return `
    --local-color-1: ${p[0]};
    --local-color-2: ${p[1]};
   ...
   `;
        ...
        tintColor (e, t) {
            const [o, r, n] = e, i = Math.round(o + (255 - o) * t), a = Math.round(r + (255 - r) * t), s = Math.round(n + (255 - n) * t);
            return [
                i,
                a,
                s
        ...
        maskInput ({ value: e, decimals: t, integers: o }) {
            if (e = e.replace(",", "."), e === G) return `0${G}`;
            const [r = "", n] = e.split(G).map((E)=>E.replace(/[^0-9]/gu, "")), i = o ? r.substring(0, o) : r, a = i.length === 2 ? String(Number(i)) : i, s = typeof t == "number" ? n?.substring(0, t) : n, p = typeof t != "number" || t > 0;
    ...
    w = function(e) {
        return function(o) {
            return typeof o == "function" ? de(e, o) : he(e, o);
        };
    };
    const ue = {
        attribute: !0,
        ...
        const { kind: r, metadata: n } = o;
        let i = globalThis.litPropertyMetadata.get(n);
        if (i === void 0 && globalThis.litPropertyMetadata.set(n, i = new Map), r === "setter" && ((e = Object.create(e)).wrapped = !0), i.set(o.name, e), r === "accessor") {
            const { name: a } = o;
            return {
                set (s) {
                    const p = t.get.call(this);
                    t.set.call(this, s), this.requestUpdate(a, p, e, !0, s);
                },
                init (s) {
        ...
        if (r === "setter") {
            ...
            return function(s) {
                const p = this[a];
                t.call(this, s), this.requestUpdate(a, p, e, !0, s);
            };
        }
        throw Error("Unsupported decorator location: " + r);
    };
    l = function(e) {
        return (t, o)=>typeof o == "object" ? pe(e, t, o) : ((r, n, i)=>{
...
`;
    var $ = function(e, t, o, r) {
        var n = arguments.length, i = n < 3 ? t : r === null ? r = Object.getOwnPropertyDescriptor(t, o) : r, a;
        if (typeof Reflect == "object" && typeof Reflect.decorate == "function") i = Reflect.decorate(e, t, o, r);
        else for(var s = e.length - 1; s >= 0; s--)(a = e[s]) && (i = (n < 3 ? a(i) : n > 3 ? a(t, o, i) : a(t, o)) || i);
    ...
    S = (e)=>e ?? se;
    const re = Symbol.for(""), fe = (e)=>{
        if (e?.r === re) return e?._$litStatic$;
    }, me = (e)=>({
            _$litStatic$: e,
            r: re
        }), te = new Map, ve = (e)=>(t, ...o)=>{
            ...
            let p, _ = 0, E = !1;
            for(; _ < r;){
                for(p = t[_]; _ < r && (i = o[_], (n = fe(i)) !== void 0);)p += n + t[++_], E = !0;
                _ !== r && s.push(i), a.push(p), _++;
            }
            if (_ === r && a.push(t[r]), E) {
                const ee = a.join("$$lit$$");
                (t = te.get(ee)) === void 0 && (a.raw = a, te.set(ee, t = a)), o = s;
            }
            return e(t, ...o);
        }, ie = ve(h), we = d`<svg width="30" height="30" viewBox="0 0 30 30" fill="none">
...
</svg>`, Se = d`<svg fill="none" viewBox="0 0 16 16">
  <path
    fill="currentColor"
...
`, Ze = d`<svg fill="none" viewBox="0 0 40 40">
  <g clip-path="url(#a)">
    <g clip-path="url(#b)">
...
</svg>`, Be = d`<svg fill="none" viewBox="0 0 16 16">
  <path
    fill="currentColor"
...
`;
    ...
    const Ne = {
        ...
        "ph-arrow-circle-down": ()=>c(()=>import("./PhArrowCircleDown-BtlNV0TZ.js"), __vite__mapDeps([0,1])),
        "ph-arrow-clockwise": ()=>c(()=>import("./PhArrowClockwise-mOiWYLMV.js"), __vite__mapDeps([2,1])),
        "ph-arrow-down": ()=>c(()=>import("./PhArrowDown-CkoOD89h.js"), __vite__mapDeps([3,1])),
        "ph-arrow-left": ()=>c(()=>import("./PhArrowLeft-C0jlxVhM.js"), __vite__mapDeps([4,1])),
        "ph-arrow-right": ()=>c(()=>import("./PhArrowRight-BI-V03Xf.js"), __vite__mapDeps([5,1])),
        "ph-arrow-square-out": ()=>c(()=>import("./PhArrowSquareOut-DnQ7n_B4.js"), __vite__mapDeps([6,1])),
        "ph-arrows-down-up": ()=>c(()=>import("./PhArrowsDownUp-PZosTqZG.js"), __vite__mapDeps([7,1])),
        "ph-arrows-left-right": ()=>c(()=>import("./PhArrowsLeftRight-CYsRQ2qh.js"), __vite__mapDeps([8,1])),
        "ph-arrow-up": ()=>c(()=>import("./PhArrowUp-izKvURUW.js"), __vite__mapDeps([9,1])),
        "ph-arrow-up-right": ()=>c(()=>import("./PhArrowUpRight-Bn-JhHsY.js"), __vite__mapDeps([10,1])),
        "ph-arrows-clockwise": ()=>c(()=>import("./PhArrowsClockwise-Brtx2Re-.js"), __vite__mapDeps([11,1])),
        "ph-bank": ()=>c(()=>import("./PhBank-hhPAIPVb.js"), __vite__mapDeps([12,1])),
        "ph-browser": ()=>c(()=>import("./PhBrowser-BjzAmrHO.js"), __vite__mapDeps([13,1])),
        "ph-caret-down": ()=>c(()=>import("./PhCaretDown-ddSjwcwm.js"), __vite__mapDeps([14,1])),
        "ph-caret-left": ()=>c(()=>import("./PhCaretLeft-B7YLoNEF.js"), __vite__mapDeps([15,1])),
        "ph-caret-right": ()=>c(()=>import("./PhCaretRight-BY8D5MIg.js"), __vite__mapDeps([16,1])),
        "ph-caret-up": ()=>c(()=>import("./PhCaretUp-BG10nSut.js"), __vite__mapDeps([17,1])),
        "ph-check": ()=>c(()=>import("./PhCheck-DrKd7pBC.js"), __vite__mapDeps([18,1])),
        "ph-circle-half": ()=>c(()=>import("./PhCircleHalf-Bk9C4DvT.js"), __vite__mapDeps([19,1])),
        "ph-clock": ()=>c(()=>import("./PhClock-Sj17weCB.js"), __vite__mapDeps([20,1])),
        "ph-compass": ()=>c(()=>import("./PhCompass-Df1ugFO-.js"), __vite__mapDeps([21,1])),
        "ph-copy": ()=>c(()=>import("./PhCopy-rgttky8E.js"), __vite__mapDeps([22,1])),
        "ph-credit-card": ()=>c(()=>import("./PhCreditCard-CZpdid2n.js"), __vite__mapDeps([23,1])),
        "ph-currency-dollar": ()=>c(()=>import("./PhCurrencyDollar-B6IKKjue.js"), __vite__mapDeps([24,1])),
        "ph-desktop": ()=>c(()=>import("./PhDesktop-BuCDXYJj.js"), __vite__mapDeps([25,1])),
        "ph-device-mobile": ()=>c(()=>import("./PhDeviceMobile-CnybhXY-.js"), __vite__mapDeps([26,1])),
        "ph-dots-three": ()=>c(()=>import("./PhDotsThree-CSAEcba1.js"), __vite__mapDeps([27,1])),
        "ph-vault": ()=>c(()=>import("./PhVault-B8m1usHw.js"), __vite__mapDeps([28,1])),
        "ph-envelope": ()=>c(()=>import("./PhEnvelope-SmaNeXoQ.js"), __vite__mapDeps([29,1])),
        "ph-funnel-simple": ()=>c(()=>import("./PhFunnelSimple-DKx35ITq.js"), __vite__mapDeps([30,1])),
        "ph-globe": ()=>c(()=>import("./PhGlobe-q1mqj65V.js"), __vite__mapDeps([31,1])),
        "ph-identification-card": ()=>c(()=>import("./PhIdentificationCard-BeLXJpfZ.js"), __vite__mapDeps([32,1])),
        "ph-image": ()=>c(()=>import("./PhImage-BYrKfN9k.js"), __vite__mapDeps([33,1])),
        "ph-info": ()=>c(()=>import("./PhInfo-X33f06Ej.js"), __vite__mapDeps([34,1])),
        "ph-lightbulb": ()=>c(()=>import("./PhLightbulb-DMZJsowR.js"), __vite__mapDeps([35,1])),
        "ph-magnifying-glass": ()=>c(()=>import("./PhMagnifyingGlass-B6D0sWFL.js"), __vite__mapDeps([36,1])),
        "ph-paper-plane-right": ()=>c(()=>import("./PhPaperPlaneRight-Dvo-nXr9.js"), __vite__mapDeps([37,1])),
        "ph-plus": ()=>c(()=>import("./PhPlus-CBvZvLax.js"), __vite__mapDeps([38,1])),
        "ph-power": ()=>c(()=>import("./PhPower-D8-AcNM6.js"), __vite__mapDeps([39,1])),
        "ph-puzzle-piece": ()=>c(()=>import("./PhPuzzlePiece-C-7mYqGO.js"), __vite__mapDeps([40,1])),
        "ph-qr-code": ()=>c(()=>import("./PhQrCode-uIXlI5ER.js"), __vite__mapDeps([41,1])),
        "ph-question": ()=>c(()=>import("./PhQuestion-rUoqC2sC.js"), __vite__mapDeps([42,1])),
        "ph-question-circle": ()=>c(()=>import("./PhQuestionMark-W55Txvvb.js"), __vite__mapDeps([43,1])),
        "ph-seal-check": ()=>c(()=>import("./PhSealCheck-BeVLq9PH.js"), __vite__mapDeps([44,1])),
        "ph-sign-out": ()=>c(()=>import("./PhSignOut-Cq2PivQ6.js"), __vite__mapDeps([45,1])),
        "ph-spinner": ()=>c(()=>import("./PhSpinner-CZMtAFdX.js"), __vite__mapDeps([46,1])),
        "ph-trash": ()=>c(()=>import("./PhTrash-BamrmMsN.js"), __vite__mapDeps([47,1])),
        "ph-user": ()=>c(()=>import("./PhUser-A2fxqIV0.js"), __vite__mapDeps([48,1])),
        "ph-wallet": ()=>c(()=>import("./PhWallet-WVAuHGpA.js"), __vite__mapDeps([49,1])),
        "ph-warning": ()=>c(()=>import("./PhWarning-CpkID9oi.js"), __vite__mapDeps([50,1])),
        "ph-warning-circle": ()=>c(()=>import("./PhWarningCircle-Cm58gXb9.js"), __vite__mapDeps([51,1])),
        "ph-x": ()=>c(()=>import("./PhX-C3b4cCEy.js"), __vite__mapDeps([52,1]))
    }, qe = {
        appStore: we,
        apple: be,
        bitcoin: $e,
        ...
        twitterIcon: Be,
        walletConnect: De,
        walletConnectInvert: je,
        walletConnectBrown: Ue,
        walletConnectLightBrown: We,
        x: oe,
        infoSeal: Ve,
        checkmark: Ce
    }, Ye = {
        "accent-primary": u.tokens.core.iconAccentPrimary,
        "accent-certified": u.tokens.core.iconAccentCertified,
        "foreground-secondary": u.tokens.theme.foregroundSecondary,
        default: u.tokens.theme.iconDefault,
        success: u.tokens.core.iconSuccess,
        error: u.tokens.core.iconError,
        warning: u.tokens.core.iconWarning,
        inverse: u.tokens.theme.iconInverse
    };
    let A = class extends v {
      ...
      --local-color: ${this.color === "inherit" ? "inherit" : Ye[this.color]}
    `;
            const o = Ne[this.name];
            if (o && o !== "") {
                const r = Ge[o];
                r && r();
                const n = me(o);
    ...
    Qe = Je(class extends Ke {
        ...
        update(e, [t]) {
            if (this.st === void 0) {
                this.st = new Set, e.strings !== void 0 && (this.nt = new Set(e.strings.join(" ").split(/\s/).filter((r)=>r !== "")));
            ...
            for(const r in t){
                const n = !!t[r];
                n === this.st.has(r) || this.nt?.has(r) || (n ? (o.add(r), this.st.add(r)) : (o.remove(r), this.st.delete(r)));
            }
            return ce;
        }
    });
...
`;
    ...
    const tt = {
        primary: u.tokens.theme.textPrimary,
        secondary: u.tokens.theme.textSecondary,
        tertiary: u.tokens.theme.textTertiary,
        invert: u.tokens.theme.textInvert,
        error: u.tokens.core.textError,
        success: u.tokens.core.textSuccess,
        warning: u.tokens.core.textWarning,
        "accent-primary": u.tokens.core.textAccentPrimary
    };
    let V = class extends v {
      ...
      --local-color: ${this.color === "inherit" ? "inherit" : tt[this.color ?? "primary"]};
      `, h`<slot class=${Qe(t)}></slot>`;
        }
    };
    V.styles = [
        b,
...
`;
    ...
    let x = class extends v {
      ...
      `, this.dataset.boxed = this.boxed ? "true" : "false", this.dataset.rounded = this.rounded ? "true" : "false", this.dataset.full = this.fullSize ? "true" : "false", this.dataset.icon = this.iconColor || "inherit", this.icon ? h`<wui-icon
        ...
        name=${this.icon}
        size="lg"
      ></wui-icon> ` : this.logo ? h`<wui-icon size="lg" color="inherit" name=${this.logo}></wui-icon> ` : h`<img src=${S(this.src)} alt=${this.alt} @error=${this.handleImageError} />`;
        }
        handleImageError() {
    ...
    P([
        l()
    ], x.prototype, "src", void 0);
    P([
        l()
    ], x.prototype, "logo", void 0);
    P([
        l()
    ], x.prototype, "icon", void 0);
    P([
        l()
    ], x.prototype, "iconColor", void 0);
    P([
        l()
    ], x.prototype, "alt", void 0);
    P([
        l()
    ...
    ], x.prototype, "boxed", void 0);
    P([
        l({
            type: Boolean
        })
    ], x.prototype, "rounded", void 0);
    P([
        l({
            type: Boolean
        })
    ], x.prototype, "fullSize", void 0);
    x = P([
        w("wui-image")
    ], x);
    const rt = L`
...
`;
    ...
    let q = class extends v {
        ...
        render() {
            const t = this.walletImages.length < X;
            return h`${this.walletImages.slice(0, X).map(({ src: o, walletName: r })=>h`
          <wui-wallet-image
            size="sm"
            imageSrc=${o}
            name=${S(r)}
        ...
        `)}
    ${t ? [
                ...Array(X - this.walletImages.length)
    ...
    ], q.prototype, "walletImages", void 0);
    q = ne([
        w("wui-all-wallets-image")
    ], q);
    const at = L`
  :host {
    display: flex;
...
`;
    ...
    `;
        ...
        templateNamespaces() {
            return this.namespaces?.length ? h`<wui-flex alignItems="center" gap="0">
...
`;
    ...
    Q([
        l()
    ], j.prototype, "color", void 0);
    Q([
        l()
    ], j.prototype, "size", void 0);
    j = Q([
        w("wui-loading-spinner")
    ], j);
    const ht = L`
  :host {
    width: var(--local-width);
...
`;
    ...
    --local-width: ${this.fullWidth ? "100%" : "auto"};
     `;
            const t = this.textVariant ?? dt[this.size];
            return h`
    ...
    `;
        ...
        loadingTemplate() {
            if (this.loading) {
                const t = ut[this.size], o = this.variant === "neutral-primary" || this.variant === "accent-primary" ? "invert" : "primary";
                return h`<wui-loading-spinner color=${o} size=${t}></wui-loading-spinner>`;
            }
            return null;
        }
    };
    ...
    T([
        l()
    ], k.prototype, "textVariant", void 0);
    k = T([
        w("wui-button")
    ], k);
    const pt = L`
...
`;
    ...
    let O = class extends v {
      ...
      <button ?disabled=${this.disabled} data-variant=${this.variant}>
        <slot name="iconLeft"></slot>
        <wui-text
          color=${ft[this.variant]}
          variant=${gt[this.size]}
        >
          <slot></slot>
        </wui-text>
        ${this.iconTemplate()}
...
`;
    ...
    let H = class extends v {
      ...
      width: ${this.width};
      height: ${this.height};
    `, this.dataset.rounded = this.rounded ? "true" : "false", h`<slot></slot>`;
        }
    };
    H.styles = [
        mt
    ...
    ], H.prototype, "rounded", void 0);
    H = N([
        w("wui-shimmer")
    ], H);
    const vt = "https://reown.com", wt = L`
  .reown-logo {
    height: 24px;
  }
...
`;
    ...
    let $t;
    Tt = d`<svg  viewBox="0 0 48 54" fill="none">
  <path
...
`;
    ...
    ></wui-image>`;
        ...
        templateRightIcon() {
            return this.rightIcon ? this.loading ? h`<wui-loading-spinner size="md" color="accent-primary"></wui-loading-spinner>` : h`<wui-icon name="chevronRight" size="lg" color="default"></wui-icon>` : null;
        }
    };
    m.styles = [
        b,
    ...
    y([
        l()
    ], m.prototype, "imageSrc", void 0);
    y([
        l()
    ], m.prototype, "imageSize", void 0);
    y([
        l()
    ...
    y([
        l()
    ], m.prototype, "tabIdx", void 0);
    y([
        l()
    ], m.prototype, "boxColor", void 0);
    y([
        l({
            type: Boolean
        })
    ...
    ], m.prototype, "rightIcon", void 0);
    y([
        l({
            type: Boolean
        })
    ], m.prototype, "boxed", void 0);
    y([
        l({
            type: Boolean
        })
    ], m.prototype, "rounded", void 0);
    y([
        l({
            type: Boolean
        })
    ], m.prototype, "fullSize", void 0);
    m = y([
        w("wui-list-item")
    ], m);
});
export { I as U, Qe as a, Tt as b, w as c, Je as e, Ke as i, l as n, S as o, _t as r, Xe as t, __tla };
