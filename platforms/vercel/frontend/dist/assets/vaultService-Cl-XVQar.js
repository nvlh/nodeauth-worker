...
import { f as F, r as Q, E as x, n as H, x as D, B as g, H as G, N as w, M as K, C as q, s as W, R as b, Q as M, __tla as __tla_1 } from "./index-DSbcHvgg.js";
        ...
        async getTrashList () {
            ...
            try {
                const { useLayoutStore: n } = await z(async ()=>{
                    const { useLayoutStore: o } = await import("./index-DSbcHvgg.js").then(async (m)=>{
                        await m.__tla;
                        return m;
                    }).then((s)=>s.w);
                    return {
        ...
        if (t && t.secret && !t.secret.startsWith("nodeauth:")) {
            ...
            if (r) {
                const { maskSecretFront: i } = await z(async ()=>{
                    const { maskSecretFront: o } = await import("./index-DSbcHvgg.js").then(async (m)=>{
                        await m.__tla;
                        return m;
                    }).then((s)=>s.m);
                    return {
                        ...
                        if (!p?.success) {
                            ...
                            if (v) {
                                ...
                                const { useOfflineStore: m } = await z(async ()=>{
                                    const { useOfflineStore: y } = await import("./index-DSbcHvgg.js").then(async (m)=>{
                                        await m.__tla;
                                        return m;
                                    }).then((T)=>T.y);
                                    return {
