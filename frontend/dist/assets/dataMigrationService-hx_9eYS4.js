const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/qr-utils-7t4IiZrV.js","assets/element-plus-BHS6vjDl.js","assets/vue-core-DHcoxuim.js","assets/element-plus-CqJ-3YyC.css","assets/index-C2a-FyYM.js","assets/pdf-utils-D3SLYqmy.js","assets/compression-utils-BzBbrBKd.js","assets/simplewebauthn-3qpiAaRi.js","assets/tanstack-query-DV2JH8XC.js","assets/index-BvTGjkv3.css"])))=>i.map(i=>d[i]);
import { _ as j, __tla as __tla_0 } from "./pdf-utils-D3SLYqmy.js";
import { n as pe, O as _e, p as V, b as te, v as fe, __tla as __tla_1 } from "./vaultService-C5XSNrey.js";
...
import { x as ue, o as Ue, q as De, __tla as __tla_2 } from "./index-C2a-FyYM.js";
    ...
    _t = {
        ...
        async fetchAllVault () {
            ...
            try {
                const { useAppLockStore: e } = await j(async ()=>{
                    const { useAppLockStore: c } = await import("./index-C2a-FyYM.js").then(async (m)=>{
                        await m.__tla;
                        return m;
                    }).then((u)=>u.b);
                    return {
                    ...
                    const { unmaskSecretFront: c } = await import("./index-C2a-FyYM.js").then(async (m)=>{
                        await m.__tla;
                        return m;
                    }).then((u)=>u.m);
                    return {
        ...
        async saveImportedVault (n) {
            const { useAppLockStore: r } = await j(async ()=>{
                ...
                const { maskSecretFront: i } = await import("./index-C2a-FyYM.js").then(async (m)=>{
                    await m.__tla;
                    return m;
                }).then((c)=>c.m);
                return {
